...
"systems.card3.d":"أداة تساعد المستخدمين على إنشاء سيرة ذاتية بشكل أسرع وأوضح وبتجربة أسهل.",
"systems.card3.p1":"بناء السيرة الذاتية بسهولة",
"systems.card3.p2":"تنظيم المحتوى بشكل احترافي",

"systems.card4.kicker":"إدارة الحضور",
"systems.card4.t":"نظام الحضور الذكي",
"systems.card4.d":"نظام حضور ذكي يعتمد على التعرف على الوجوه لتسجيل الحضور تلقائيًا عبر الكاميرا، مع تقليل الأخطاء اليدوية وتحسين المتابعة اليومية.",
...
"solutions.attendance.b2":"تقارير حضور وتنظيم أفضل",
        ...
        "hero.h1a":"نبني مواقع",
        "hero.h1b":"وتطبيقات ذكية",
        "hero.h1c":"تنمّي أعمالك بسرع",
...
"results.c3k":"نظام مخصص",        "results.c3t":"تشغيل أوضح ووقت أقل ضائع",
      ...
      "security.card2.kicker":"التطبيق",
      "security.card3.kicker":"النشر",
      ...
      "msg.statusConfigHelp":"فعّل Cloudflare وSecurity Headers من جهة الاستضافة للحصول على حماية أقوى على الإنتاج.",
        ...
        "about.h":"من نحن",
        "about.d":"Aqua.Tech شريك رقمي للشركات ورواد الأعمال الذين يريدون حضورًا أقوى على الإنترنت، وعمليات أذكى، وحلولًا عملية مبنية للنمو. نجمع بين التنفيذ التقني، الأتمتة، والتسليم الموجّه لنتائج الأعمال.",
...
"form.budgetOpt4":"$4,000+",
        ...
        "form.opt9":"منشئ السيرة الذكية",
        "form.opt10":"نظام الحضور الذكي",
...
"footer.instagram":"Instagram",
        ...
        "faq.a7":"نعم، نسلّم الموقع جاهزًا للنشر والاستخدام، مع شرح واضح لطريقة الإدارة والتحديثات الأساسية، بدون تسليم ملفات الكود إلا إذا تم الاتفاق على ذلك مسبقًا.",
...
"stats.projectsT":"مشروع منجز",
      ...
      en: {
        ...
        "systems.h":"Customizable solutions",
"systems.sub":"Solution models that can be adapted to your business type and project stage for a faster and more professional launch.",
        "systems.cta":"Request the right system ",
        "systems.cardCta":"Request this system ",
        "systems.card1.kicker":"Legal operations",
        "systems.card1.t":"Law Firm Operations System",
...
"security.note.d":"No website is 100% impossible to breach, but it can be built with stronger protection that reduces risks and makes attacks harder and more costly.",
"security.note.extra":"For stronger production protection, enable Cloudflare, HSTS, and WAF on your hosting or CDN.",
...
"form.budgetOpt4":"$4,000+",
        ...
        "form.security1":"🔒 Verified inputs",
        "form.security2":"🛡️ Spam protection",
        ...
        "form.opt7":"Law Firm Operations System",
...
"about.tag3":"Growth & operations solutions",
        ...
        "faq.q7":"Does delivery include website management guidance?",
        "faq.a7":"Yes, we deliver the website ready for launch and use, with clear guidance on basic management and updates. Source code is not included unless agreed upon separately.",
...
"footer.instagram":"Instagram",
    ...
    function setLang(lang){
      ...
      if (typeof updateDynamicContactLinks === "function") {
