(function () {
  ...
  function translateAttributes(lang) {
    ...
    document.querySelectorAll("[alt]").forEach((el) => {
      ...
      if (value && map[value]) el.setAttribute("alt", map[value]);
    });
  }
  ...
  const KEY_TRANSLATIONS = {
    ...
    en: {
      ...
      "footer.support": "Post-launch support",
  ...
  function translateDataI18n(lang) {
    const dict = KEY_TRANSLATIONS[lang] || KEY_TRANSLATIONS.ar;
  ...
  window.setLang = applyAquaLanguage;
